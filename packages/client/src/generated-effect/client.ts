...
type Endpoint3_6Request = Parameters<RawClient["server.session"]["session.profile"]>[0]
...
const Endpoint3_6 = (raw: RawClient["server.session"]) => (input: Endpoint3_6Input) =>
  raw["session.profile"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint3_7Request = Parameters<RawClient["server.session"]["session.profile.set"]>[0]
type Endpoint3_7Input = {
  readonly sessionID: Endpoint3_7Request["params"]["sessionID"]
  readonly profile: Endpoint3_7Request["payload"]["profile"]
}
const Endpoint3_7 = (raw: RawClient["server.session"]) => (input: Endpoint3_7Input) =>
  raw["session.profile.set"]({
    params: { sessionID: input["sessionID"] },
    payload: { profile: input["profile"] },
  }).pipe(Effect.mapError(mapClientError))

type Endpoint3_8Request = Parameters<RawClient["server.session"]["session.profile.reset"]>[0]
...
const Endpoint3_8 = (raw: RawClient["server.session"]) => (input: Endpoint3_8Input) =>
  raw["session.profile.reset"]({ params: { sessionID: input["sessionID"] } }).pipe(Effect.mapError(mapClientError))
...
const adaptGroup3 = (raw: RawClient["server.session"]) => ({
  ...
  profile: Endpoint3_6(raw),
  set: Endpoint3_7(raw),
  reset: Endpoint3_8(raw),
