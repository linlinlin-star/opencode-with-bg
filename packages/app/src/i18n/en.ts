...
export const dict = {
  ...
  "session.gitGraph.commits": "commits",
  "session.gitGraph.expand": "Expand",
  "session.gitGraph.collapse": "Collapse",
  "session.gitGraph.loading": "Loading commits...",
  "session.gitGraph.empty": "No commits yet",
  "session.gitGraph.checkoutError": "Failed to switch branch",
  "session.gitGraph.branchSwitched": "Branch switched",
  "session.gitGraph.dirty.title": "Uncommitted changes",
  "session.gitGraph.dirty.description":
    "You have uncommitted changes that would be overwritten by this checkout. Discard them and continue?",
  "session.gitGraph.dirty.cancel": "Cancel",
  "session.gitGraph.dirty.confirm": "Discard & switch",
  "session.gitGraph.commit.loading": "Loading changes...",
  "session.gitGraph.commit.noChanges": "No file changes",

  "session.markdown.source": "Source",
  "session.markdown.split": "Split",
  "session.markdown.preview": "Preview",
  "session.markdown.outline": "Outline",
  "session.markdown.outline.empty": "No headings",
  "session.conversation.outline": "Conversation",
  "session.conversation.outline.empty": "No messages",
  ...
  "settings.tab.rules": "Rules & Config",
  "settings.rules.refresh": "Refresh",
  "settings.rules.empty": "No effective rules found.",
  "settings.rules.error": "Failed to load rules: {{error}}",
  "settings.rules.effective.title": "Effective rules",
  "settings.rules.user.title": "User rules",
  "settings.rules.user.description":
    "Personal rules you define are appended to the system prompt of every session. Toggle them on to apply them across all projects.",
  "settings.rules.user.name.placeholder": "Rule name, e.g. english-comments",
  "settings.rules.user.content.placeholder": "Rule content, e.g. Always write code comments in English.",
  "settings.rules.user.add": "Add",
  "settings.rules.user.add.confirm": "Add",
  "settings.rules.user.cancel": "Cancel",
  "settings.rules.user.remove.label": "Remove rule",
  "settings.tab.profile": "Profile",
  "settings.profile.unsupported.v1": "Session profiles require the V2 server.",
  "settings.profile.noSession": "Open a session to edit its profile.",
  "settings.profile.skills.empty": "No effective skills in this project.",
  "settings.profile.skills.addFolder": "Add skill folder",
  "settings.profile.skills.addError": "Failed to register skill folder",
  "settings.profile.skills.effective.title": "Effective skills in this project",
  "settings.profile.skills.source.project": "Project",
  "settings.profile.skills.source.global": "Global",
  "settings.profile.skills.mode.title": "Skill mode",
  "settings.profile.skills.mode.description":
    "Inherit mode includes global .opencode and project .opencode skills; deny mode only uses the current project's .opencode skills.",
  "settings.profile.skills.mode.inherit": "Inherit",
  "settings.profile.skills.mode.deny": "Deny",
  "settings.profile.skills.modeError": "Failed to update skill mode",
  ...
  "settings.general.row.backgroundImage.description":
    "Show a background image behind the app. Adjust dimming to keep text readable.",
  "settings.general.row.backgroundImage.choose": "Choose image",
  "settings.general.row.backgroundImage.clear": "Clear",
  "settings.general.row.backgroundImage.opacity": "Image opacity",
  "settings.general.row.backgroundImage.blur": "Blur",
  "settings.general.row.backgroundImage.dim": "Content dimming",
  "settings.general.row.backgroundImage.size": "Size",
  "settings.general.row.backgroundImage.repeat": "Tile",
  "settings.general.backgroundImage.size.cover": "Cover",
  "settings.general.backgroundImage.size.contain": "Contain",
  "settings.general.backgroundImage.size.auto": "Original",
  ...
  "desktopMenu.newSession": "New Session",
  "desktopMenu.openProject": "Open Project...",
  "desktopMenu.settings": "Settings",
  "desktopMenu.newWindow": "New Window",
  "desktopMenu.closeWindow": "Close Window",
  "desktopMenu.undo": "Undo",
  "desktopMenu.redo": "Redo",
  "desktopMenu.cut": "Cut",
  "desktopMenu.copy": "Copy",
  "desktopMenu.paste": "Paste",
  "desktopMenu.delete": "Delete",
  "desktopMenu.selectAll": "Select All",
  "desktopMenu.toggleSidebar": "Toggle Sidebar",
  "desktopMenu.toggleTerminal": "Toggle Terminal",
  "desktopMenu.toggleFileTree": "Toggle File Tree",
  "desktopMenu.reload": "Reload",
  "desktopMenu.toggleDevTools": "Toggle Developer Tools",
  "desktopMenu.actualSize": "Actual Size",
  "desktopMenu.zoomIn": "Zoom In",
  "desktopMenu.zoomOut": "Zoom Out",
  "desktopMenu.toggleFullScreen": "Toggle Full Screen",
  "desktopMenu.back": "Back",
  "desktopMenu.forward": "Forward",
  "desktopMenu.previousSession": "Previous Session",
  "desktopMenu.nextSession": "Next Session",
  "desktopMenu.previousProject": "Previous Project",
  "desktopMenu.nextProject": "Next Project",
  "desktopMenu.minimize": "Minimize",
  "desktopMenu.maximize": "Maximize",
  "desktopMenu.documentation": "OpenCode Documentation",
  "desktopMenu.supportForum": "Support Forum",
  "desktopMenu.exportLogs": "Export Logs...",
  "desktopMenu.shareFeedback": "Share Feedback",
  "desktopMenu.reportBug": "Report a Bug",
}
