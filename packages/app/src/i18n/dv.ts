export const dict = {
  ...
  "session.gitGraph.dirty.description": "You have uncommitted changes that would be overwritten by this checkout. Discard them and continue?",
  ...
  "settings.general.row.backgroundImage.description": "Show a background image behind the app. Adjust dimming to keep text readable.",
  ...
  "settings.profile.skills.mode.description": "Inherit mode includes global .opencode and project .opencode skills; deny mode only uses the current project's .opencode skills.",
  ...
  "settings.rules.user.description": "Personal rules you define are appended to the system prompt of every session. Toggle them on to apply them across all projects.",
