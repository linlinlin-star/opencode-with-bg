...
export const dict = {
  ...
  "session.gitGraph.title": "Git 图",
  "session.gitGraph.commits": "个提交",
  "session.gitGraph.expand": "展开",
  "session.gitGraph.collapse": "折叠",
  "session.gitGraph.loading": "正在加载提交...",
  "session.gitGraph.empty": "暂无提交",
  "session.gitGraph.checkoutError": "切换分支失败",
  "session.gitGraph.branchSwitched": "分支已切换",
  "session.gitGraph.dirty.title": "存在未提交的更改",
  "session.gitGraph.dirty.description": "当前有未提交的更改，切换分支将被覆盖。是否丢弃并继续？",
  "session.gitGraph.dirty.cancel": "取消",
  "session.gitGraph.dirty.confirm": "丢弃并切换",
  "session.gitGraph.commit.loading": "正在加载变更...",
  "session.gitGraph.commit.noChanges": "无文件变更",

  "session.markdown.source": "源码",
  "session.markdown.split": "分屏",
  "session.markdown.preview": "预览",
  "session.markdown.outline": "大纲",
  "session.markdown.outline.empty": "暂无标题",
  "session.conversation.outline": "对话",
  "session.conversation.outline.empty": "暂无对话",
  ...
  "settings.tab.rules": "规则与配置",
  "settings.rules.refresh": "刷新",
  "settings.rules.empty": "没有找到生效的规则文件。",
  "settings.rules.error": "加载生效规则失败：{{error}}",
  "settings.rules.effective.title": "生效规则",
  "settings.rules.user.title": "用户规则",
  "settings.rules.user.description":
    "你自定义的个人规则会附加到每个会话的系统提示词中。开启后对所有项目生效，不会覆盖项目自身的 AGENTS.md。",
  "settings.rules.user.name.placeholder": "规则名称，例如：英文注释",
  "settings.rules.user.content.placeholder": "规则内容，例如：所有代码注释一律使用英文。",
  "settings.rules.user.add": "添加",
  "settings.rules.user.add.confirm": "添加",
  "settings.rules.user.cancel": "取消",
  "settings.rules.user.remove.label": "删除规则",
  "settings.tab.profile": "会话配置",
  "settings.profile.unsupported.v1": "会话配置需要 V2 服务器。",
  "settings.profile.noSession": "打开会话后可编辑其配置。",
  "settings.profile.skills.empty": "当前项目没有生效技能。",
  "settings.profile.skills.addFolder": "添加技能文件夹",
  "settings.profile.skills.addError": "注册技能文件夹失败",
  "settings.profile.skills.effective.title": "当前项目有效技能",
  "settings.profile.skills.source.project": "项目",
  "settings.profile.skills.source.global": "全局",
  "settings.profile.skills.mode.title": "技能模式",
  "settings.profile.skills.mode.description":
    "继承模式包含全局 .opencode 与项目 .opencode 的技能；禁止模式仅使用当前项目 .opencode 中的技能。",
  "settings.profile.skills.mode.inherit": "继承",
  "settings.profile.skills.mode.deny": "禁止",
  "settings.profile.skills.modeError": "更新技能模式失败",
  ...
  "settings.general.row.backgroundImage.title": "背景图片",
  "settings.general.row.backgroundImage.description": "在应用背后显示背景图片。调节内容压暗以保持文字可读。",
  "settings.general.row.backgroundImage.choose": "选择图片",
  "settings.general.row.backgroundImage.clear": "清除",
  "settings.general.row.backgroundImage.opacity": "图片不透明度",
  "settings.general.row.backgroundImage.blur": "模糊",
  "settings.general.row.backgroundImage.dim": "内容压暗",
  "settings.general.row.backgroundImage.size": "尺寸",
  "settings.general.row.backgroundImage.repeat": "平铺",
  "settings.general.backgroundImage.size.cover": "填充",
  "settings.general.backgroundImage.size.contain": "适应",
  "settings.general.backgroundImage.size.auto": "原始",
  ...
  "desktopMenu.view": "查看",
  "desktopMenu.go": "前往",
  "desktopMenu.window": "窗口",
  "desktopMenu.help": "帮助",
  "desktopMenu.newSession": "新建会话",
  "desktopMenu.openProject": "打开项目...",
  "desktopMenu.settings": "设置",
  "desktopMenu.newWindow": "新建窗口",
  "desktopMenu.closeWindow": "关闭窗口",
  "desktopMenu.undo": "撤销",
  "desktopMenu.redo": "重做",
  "desktopMenu.cut": "剪切",
  "desktopMenu.copy": "复制",
  "desktopMenu.paste": "粘贴",
  "desktopMenu.delete": "删除",
  "desktopMenu.selectAll": "全选",
  "desktopMenu.toggleSidebar": "切换侧边栏",
  "desktopMenu.toggleTerminal": "切换终端",
  "desktopMenu.toggleFileTree": "切换文件树",
  "desktopMenu.reload": "重新加载",
  "desktopMenu.toggleDevTools": "切换开发者工具",
  "desktopMenu.actualSize": "实际大小",
  "desktopMenu.zoomIn": "放大",
  "desktopMenu.zoomOut": "缩小",
  "desktopMenu.toggleFullScreen": "切换全屏",
  "desktopMenu.back": "后退",
  "desktopMenu.forward": "前进",
  "desktopMenu.previousSession": "上一个会话",
  "desktopMenu.nextSession": "下一个会话",
  "desktopMenu.previousProject": "上一个项目",
  "desktopMenu.nextProject": "下一个项目",
  "desktopMenu.minimize": "最小化",
  "desktopMenu.maximize": "最大化",
  "desktopMenu.documentation": "OpenCode 文档",
  "desktopMenu.supportForum": "支持论坛",
  "desktopMenu.exportLogs": "导出日志...",
  "desktopMenu.shareFeedback": "分享反馈",
  "desktopMenu.reportBug": "报告问题",
